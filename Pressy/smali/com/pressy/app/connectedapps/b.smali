.class public Lcom/pressy/app/connectedapps/b;
...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lcom/pressy/app/connectedapps/b;->g(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_0

    const-string v0, "AutomateItPro.mainPackage"

    invoke-virtual {p0, v0}, Lcom/pressy/app/connectedapps/b;->a(Ljava/lang/String;)V
...
.method public static f(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/pressy/app/connectedapps/b;->g(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_0

    const-string v0, "com.smarterapps.automateitpro.provider.external"

    :goto_0
    return-object v0

    :cond_0
    const-string v0, "com.smarterapps.automateit.provider.external"
...
.method private static g(Landroid/content/Context;)Z
    ...
    const-string v2, "AutomateItPro.mainPackage"
...
.method public a(Landroid/content/Context;Lcom/pressy/app/ui/b/b;)Lcom/pressy/app/connectedapps/IntentWrapper;
    ...
    check-cast v0, Lcom/pressy/app/ui/b/c;

    invoke-virtual {v0}, Lcom/pressy/app/ui/b/c;->getLaunchRuleIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lcom/pressy/app/connectedapps/b;->b()Ljava/lang/String;
...
.method public a(Landroid/content/Context;)Lcom/pressy/app/ui/b/b;
    ...
    new-instance v0, Lcom/pressy/app/ui/b/c;

    invoke-direct {v0, p1}, Lcom/pressy/app/ui/b/c;-><init>(Landroid/content/Context;)V
