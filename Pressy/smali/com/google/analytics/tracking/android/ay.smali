...
.field private d:Lcom/google/analytics/tracking/android/al;
...
.method constructor <init>(Lorg/apache/http/client/HttpClient;Landroid/content/Context;)V
    ...
    invoke-static {p2}, Lcom/google/analytics/tracking/android/al;->a(Landroid/content/Context;)Lcom/google/analytics/tracking/android/al;

    move-result-object v0

    invoke-direct {p0, p1, v0, p2}, Lcom/google/analytics/tracking/android/ay;-><init>(Lorg/apache/http/client/HttpClient;Lcom/google/analytics/tracking/android/al;Landroid/content/Context;)V

    return-void
.end method

.method constructor <init>(Lorg/apache/http/client/HttpClient;Lcom/google/analytics/tracking/android/al;Landroid/content/Context;)V
    .locals 7
    ...
    iput-object v0, p0, Lcom/google/analytics/tracking/android/ay;->c:Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/google/analytics/tracking/android/bc;->a(Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/google/analytics/tracking/android/ay;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/google/analytics/tracking/android/ay;->a:Ljava/lang/String;

    iput-object p1, p0, Lcom/google/analytics/tracking/android/ay;->b:Lorg/apache/http/client/HttpClient;

    iput-object p2, p0, Lcom/google/analytics/tracking/android/ay;->d:Lcom/google/analytics/tracking/android/al;
...
.method private a(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    iget-object v2, p0, Lcom/google/analytics/tracking/android/ay;->a:Ljava/lang/String;
...
.method public a(Ljava/util/List;)I
    ...
    invoke-virtual {p0, v0}, Lcom/google/analytics/tracking/android/ay;->a(Lcom/google/analytics/tracking/android/am;)Ljava/net/URL;

    move-result-object v6

    if-nez v6, :cond_1

    invoke-static {}, Lcom/google/analytics/tracking/android/ao;->a()Z
    ...
    invoke-virtual {v0}, Lcom/google/analytics/tracking/android/am;->a()Ljava/lang/String;
    ...
    :goto_3
    invoke-direct {p0, v0, v6}, Lcom/google/analytics/tracking/android/ay;->a(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    invoke-static {v0, v8, v9}, Lcom/google/analytics/tracking/android/an;->a(Lcom/google/analytics/tracking/android/am;J)Ljava/lang/String;
    ...
    invoke-direct {p0, v6}, Lcom/google/analytics/tracking/android/ay;->a(Lorg/apache/http/HttpEntityEnclosingRequest;)V
    ...
    :cond_6
    iget-object v0, p0, Lcom/google/analytics/tracking/android/ay;->d:Lcom/google/analytics/tracking/android/al;

    invoke-virtual {v0}, Lcom/google/analytics/tracking/android/al;->b()Z
    ...
    invoke-static {v0}, Lcom/google/analytics/tracking/android/ao;->b(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/analytics/tracking/android/ay;->c:Landroid/content/Context;

    invoke-static {v0}, Lcom/google/analytics/tracking/android/w;->b(Landroid/content/Context;)V
    :try_end_0
    ...
    :goto_5
    :try_start_1
    iget-object v1, p0, Lcom/google/analytics/tracking/android/ay;->b:Lorg/apache/http/client/HttpClient;
...
.method a(Lcom/google/analytics/tracking/android/am;)Ljava/net/URL;
    .locals 3

    iget-object v0, p0, Lcom/google/analytics/tracking/android/ay;->e:Ljava/net/URL;
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/google/analytics/tracking/android/am;->d()Ljava/lang/String;
...
.method public a(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/google/analytics/tracking/android/ay;->e:Ljava/net/URL;
    :try_end_0
    .catch Ljava/net/MalformedURLException; {:try_start_0 .. :try_end_0} :catch_0
