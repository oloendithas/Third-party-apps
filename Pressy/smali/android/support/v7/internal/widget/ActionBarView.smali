...
.field private P:Landroid/support/v7/app/d;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v2, Landroid/support/v7/a/c;->actionBarStyle:I
    ...
    sget v5, Landroid/support/v7/a/h;->abc_action_bar_home:I
    ...
    sget v6, Landroid/support/v7/a/i;->abc_action_bar_up_description:I
...
.method static synthetic a(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/app/d;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->P:Landroid/support/v7/app/d;

    return-object v0
.end method

.method private a(Landroid/support/v7/internal/view/menu/q;)V
    .locals 4
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->b(Z)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->R:Landroid/support/v7/internal/widget/i;

    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/i;->b(Z)V
    ...
    invoke-virtual {v0, v1, v3}, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/q;)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->R:Landroid/support/v7/internal/widget/i;

    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->o:Landroid/content/Context;

    invoke-virtual {v0, v1, v3}, Landroid/support/v7/internal/widget/i;->a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/q;)V
...
.method static synthetic l(Landroid/support/v7/internal/widget/ActionBarView;)V
    ...
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActionBarView;->m()V
...
.method private m()V
    ...
    sget v3, Landroid/support/v7/a/h;->abc_action_bar_title_item:I
    ...
    sget v3, Landroid/support/v7/a/f;->up:I
...
# virtual methods
.method public a(Landroid/support/v4/a/a/a;Landroid/support/v7/internal/view/menu/ag;)V
    .locals 5

    const/4 v4, -0x1

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->L:Landroid/support/v7/internal/view/menu/q;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->R:Landroid/support/v7/internal/widget/i;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/q;->b(Landroid/support/v7/internal/view/menu/af;)V

    :cond_1
    check-cast p1, Landroid/support/v7/internal/view/menu/q;

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->L:Landroid/support/v7/internal/view/menu/q;
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->a(Landroid/support/v7/internal/view/menu/ag;)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->b:Landroid/support/v7/internal/view/menu/ActionMenuPresenter;

    sget v1, Landroid/support/v7/a/f;->action_menu_presenter:I
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/internal/widget/i;-><init>(Landroid/support/v7/internal/widget/ActionBarView;Landroid/support/v7/internal/widget/f;)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->R:Landroid/support/v7/internal/widget/i;
    ...
    sget v3, Landroid/support/v7/a/d;->abc_action_bar_expanded_action_views_exclusive:I
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/internal/widget/ActionBarView;->a(Landroid/support/v7/internal/view/menu/q;)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->b:Landroid/support/v7/internal/view/menu/ActionMenuPresenter;

    invoke-virtual {v0, p0}, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->a(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/ah;

    move-result-object v0

    check-cast v0, Landroid/support/v7/internal/view/menu/ActionMenuView;

    invoke-virtual {v0, p1}, Landroid/support/v7/internal/view/menu/ActionMenuView;->a(Landroid/support/v7/internal/view/menu/q;)V
...
.method public g()V
    ...
    sget v1, Landroid/support/v7/a/f;->progress_horizontal:I
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v7/app/c;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public h()V
    ...
    sget v1, Landroid/support/v7/a/f;->progress_circular:I
...
.method public j()Z
    ...
    iget-object v0, v0, Landroid/support/v7/internal/widget/i;->b:Landroid/support/v7/internal/view/menu/u;
...
.method public k()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/u;->collapseActionView()Z
...
.method protected onLayout(ZIIII)V
    ...
    instance-of v3, v0, Landroid/support/v7/app/c;
    ...
    iget v0, v5, Landroid/support/v7/app/c;->a:I
    ...
    iget v3, v5, Landroid/support/v7/app/c;->leftMargin:I

    add-int v4, v1, v3

    iget v1, v5, Landroid/support/v7/app/c;->rightMargin:I

    sub-int v3, v2, v1

    iget v2, v5, Landroid/support/v7/app/c;->topMargin:I

    iget v1, v5, Landroid/support/v7/app/c;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    instance-of v1, v2, Landroid/support/v7/app/c;
    ...
    iget v1, v11, Landroid/support/v7/app/c;->leftMargin:I

    iget v8, v11, Landroid/support/v7/app/c;->rightMargin:I

    add-int/2addr v8, v1

    iget v1, v11, Landroid/support/v7/app/c;->topMargin:I

    iget v9, v11, Landroid/support/v7/app/c;->bottomMargin:I
    ...
    iget v11, v11, Landroid/support/v7/app/c;->a:I
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/q;->findItem(I)Landroid/view/MenuItem;
...
.method public setCallback(Landroid/support/v7/app/d;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->P:Landroid/support/v7/app/d;
...
.method public setDisplayOptions(I)V
    ...
    sget v2, Landroid/support/v7/a/i;->abc_action_bar_up_description:I
    ...
    sget v2, Landroid/support/v7/a/i;->abc_action_bar_home_description:I
...
.method public setNavigationMode(I)V
    ...
    sget v2, Landroid/support/v7/a/c;->actionDropDownStyle:I
    ...
    sget v1, Landroid/support/v7/a/h;->abc_action_bar_view_list_nav_layout:I
...
.method public setSplitActionBar(Z)V
    ...
    sget v2, Landroid/support/v7/a/d;->abc_action_bar_expanded_action_views_exclusive:I
