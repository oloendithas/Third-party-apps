...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Landroid/support/v7/a/k;->ActionBar:[I

    sget v1, Landroid/support/v7/a/c;->actionBarStyle:I
...
.method private a(II)V
    ...
    check-cast v5, Landroid/support/v7/internal/view/menu/k;

    const/4 v6, 0x0

    iput-boolean v6, v5, Landroid/support/v7/internal/view/menu/k;->f:Z

    const/4 v6, 0x0

    iput v6, v5, Landroid/support/v7/internal/view/menu/k;->c:I

    const/4 v6, 0x0

    iput v6, v5, Landroid/support/v7/internal/view/menu/k;->b:I

    const/4 v6, 0x0

    iput-boolean v6, v5, Landroid/support/v7/internal/view/menu/k;->d:Z

    const/4 v6, 0x0

    iput v6, v5, Landroid/support/v7/internal/view/menu/k;->leftMargin:I

    const/4 v6, 0x0

    iput v6, v5, Landroid/support/v7/internal/view/menu/k;->rightMargin:I
    ...
    :goto_4
    iput-boolean v6, v5, Landroid/support/v7/internal/view/menu/k;->e:Z

    iget-boolean v6, v5, Landroid/support/v7/internal/view/menu/k;->a:Z
    ...
    iget-boolean v6, v5, Landroid/support/v7/internal/view/menu/k;->d:Z
    ...
    :goto_6
    iget-boolean v5, v5, Landroid/support/v7/internal/view/menu/k;->a:Z
    ...
    iget-boolean v0, v5, Landroid/support/v7/internal/view/menu/k;->d:Z
    ...
    :cond_8
    iget v0, v5, Landroid/support/v7/internal/view/menu/k;->b:I
    ...
    iget v9, v5, Landroid/support/v7/internal/view/menu/k;->b:I
    ...
    :cond_9
    iget v5, v5, Landroid/support/v7/internal/view/menu/k;->b:I
    ...
    iget-boolean v5, v5, Landroid/support/v7/internal/view/menu/k;->e:Z
    ...
    iget-boolean v0, v5, Landroid/support/v7/internal/view/menu/k;->e:Z
    ...
    iput v0, v5, Landroid/support/v7/internal/view/menu/k;->b:I

    const/16 v20, 0x1

    move/from16 v0, v20

    iput-boolean v0, v5, Landroid/support/v7/internal/view/menu/k;->f:Z
    ...
    iput-boolean v7, v5, Landroid/support/v7/internal/view/menu/k;->f:Z

    if-nez v9, :cond_14

    iget-boolean v7, v5, Landroid/support/v7/internal/view/menu/k;->e:Z
    ...
    iput v7, v5, Landroid/support/v7/internal/view/menu/k;->leftMargin:I
    ...
    :cond_15
    iget-boolean v10, v5, Landroid/support/v7/internal/view/menu/k;->a:Z
    ...
    iput v7, v5, Landroid/support/v7/internal/view/menu/k;->rightMargin:I
    ...
    iput v10, v5, Landroid/support/v7/internal/view/menu/k;->leftMargin:I
    ...
    iput v10, v5, Landroid/support/v7/internal/view/menu/k;->rightMargin:I
    ...
    iget-boolean v10, v5, Landroid/support/v7/internal/view/menu/k;->f:Z
    ...
    :cond_1a
    iget v10, v5, Landroid/support/v7/internal/view/menu/k;->b:I

    mul-int v10, v10, v25

    iget v5, v5, Landroid/support/v7/internal/view/menu/k;->c:I
