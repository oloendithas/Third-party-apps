...
# interfaces
.implements Landroid/support/v7/internal/view/menu/ai;
...
# instance fields
.field private a:Landroid/support/v7/internal/view/menu/u;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v1, Landroid/support/v7/a/d;->abc_config_allowActionMenuItemTextWithIcon:I
    ...
    sget-object v0, Landroid/support/v7/a/k;->ActionMenuItemView:[I
...
.method private e()V
    ...
    iget-object v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->a:Landroid/support/v7/internal/view/menu/u;

    invoke-virtual {v3}, Landroid/support/v7/internal/view/menu/u;->l()Z
...
# virtual methods
.method public a(Landroid/support/v7/internal/view/menu/u;I)V
    .locals 1

    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->a:Landroid/support/v7/internal/view/menu/u;

    invoke-virtual {p1}, Landroid/support/v7/internal/view/menu/u;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p0}, Landroid/support/v7/internal/view/menu/u;->a(Landroid/support/v7/internal/view/menu/ai;)Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {p0, v0}, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {p1}, Landroid/support/v7/internal/view/menu/u;->getItemId()I

    move-result v0

    invoke-virtual {p0, v0}, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->setId(I)V

    invoke-virtual {p1}, Landroid/support/v7/internal/view/menu/u;->isVisible()Z
...
.method public c()Z
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->a:Landroid/support/v7/internal/view/menu/u;

    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/u;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public getItemData()Landroid/support/v7/internal/view/menu/u;
    .locals 1
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->d:Landroid/support/v7/internal/view/menu/s;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->d:Landroid/support/v7/internal/view/menu/s;

    iget-object v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->a:Landroid/support/v7/internal/view/menu/u;

    invoke-interface {v0, v1}, Landroid/support/v7/internal/view/menu/s;->a(Landroid/support/v7/internal/view/menu/u;)Z
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    iget-object v9, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->a:Landroid/support/v7/internal/view/menu/u;

    invoke-virtual {v9}, Landroid/support/v7/internal/view/menu/u;->getTitle()Ljava/lang/CharSequence;
...
.method public setExpandedFormat(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/u;->g()V
...
.method public setItemInvoker(Landroid/support/v7/internal/view/menu/s;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->d:Landroid/support/v7/internal/view/menu/s;
