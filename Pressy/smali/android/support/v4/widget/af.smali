...
.method private a(FFI)V
    ...
    invoke-direct {p0, p3}, Landroid/support/v4/widget/af;->e(I)V
...
.method private a(IIII)Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/q;->g()V
...
.method private h()V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/aq;->a(Landroid/view/VelocityTracker;I)F
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/aq;->b(Landroid/view/VelocityTracker;I)F
...
.method public a(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v2, v3}, Landroid/support/v4/widget/af;->d(II)Landroid/view/View;
    ...
    invoke-virtual {p0, v2, v4}, Landroid/support/v4/widget/af;->b(Landroid/view/View;I)Z
    ...
    iget v5, p0, Landroid/support/v4/widget/af;->p:I
    ...
    iget v4, p0, Landroid/support/v4/widget/af;->p:I
    ...
    invoke-virtual {p0, v4, v3}, Landroid/support/v4/widget/af;->d(II)Landroid/view/View;
    ...
    invoke-direct {p0, v7, v8, v4}, Landroid/support/v4/widget/af;->b(FFI)V

    iget v9, p0, Landroid/support/v4/widget/af;->a:I
    ...
    invoke-virtual {p0, v5, v6}, Landroid/support/v4/widget/af;->d(II)Landroid/view/View;

    move-result-object v5

    if-eqz v5, :cond_7

    invoke-direct {p0, v5, v7, v8}, Landroid/support/v4/widget/af;->a(Landroid/view/View;FF)Z
    ...
    invoke-direct {p0, v2}, Landroid/support/v4/widget/af;->d(I)V
...
.method public a(Z)Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/q;->f()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/q;->d()I
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/q;->e()I
...
.method public b(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {p0, v3, v4}, Landroid/support/v4/widget/af;->d(II)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v4/widget/af;->d(II)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v4/widget/af;->c(II)Z
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/af;->h()V
...
.method public b(II)Z
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/af;->a(I)Z
    ...
    :goto_2
    iget-object v4, p0, Landroid/support/v4/widget/af;->f:[F
    ...
    iget-object v5, p0, Landroid/support/v4/widget/af;->g:[F
...
.method public c(I)Z
    ...
    invoke-virtual {p0, p1, v1}, Landroid/support/v4/widget/af;->b(II)Z
...
.method public e()V
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/af;->g()V
