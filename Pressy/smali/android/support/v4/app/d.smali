...
.method public constructor <init>(Landroid/support/v4/app/p;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/d;->a:Landroid/support/v4/app/p;
...
.method private a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;I)V
    ...
    iput p4, v0, Landroid/support/v4/app/e;->c:I

    iput-object p2, v0, Landroid/support/v4/app/e;->d:Landroid/support/v4/app/Fragment;

    invoke-virtual {p0, v0}, Landroid/support/v4/app/d;->a(Landroid/support/v4/app/e;)V
...
.method a(I)V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/d;->b:Landroid/support/v4/app/e;
...
.method a(Landroid/support/v4/app/e;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/d;->c:Landroid/support/v4/app/e;

    iput-object p1, p0, Landroid/support/v4/app/d;->b:Landroid/support/v4/app/e;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/d;->c:Landroid/support/v4/app/e;
...
.method public b(Z)V
    ...
    iget v2, v3, Landroid/support/v4/app/e;->c:I
    ...
    iget v1, v3, Landroid/support/v4/app/e;->h:I

    iput v1, v0, Landroid/support/v4/app/Fragment;->G:I

    iget-object v1, p0, Landroid/support/v4/app/d;->a:Landroid/support/v4/app/p;
    ...
    :cond_1
    :goto_1
    iget-object v0, v3, Landroid/support/v4/app/e;->b:Landroid/support/v4/app/e;
    ...
    iget v4, v3, Landroid/support/v4/app/e;->g:I

    iput v4, v0, Landroid/support/v4/app/Fragment;->G:I

    iget-object v4, p0, Landroid/support/v4/app/d;->a:Landroid/support/v4/app/p;
    ...
    iget v1, v3, Landroid/support/v4/app/e;->g:I
...
.method public run()V
    ...
    iget v0, v4, Landroid/support/v4/app/e;->c:I
    ...
    iget v2, v4, Landroid/support/v4/app/e;->c:I
    ...
    :pswitch_0
    iget-object v0, v4, Landroid/support/v4/app/e;->d:Landroid/support/v4/app/Fragment;

    iget v1, v4, Landroid/support/v4/app/e;->e:I
    ...
    :cond_2
    :goto_1
    iget-object v0, v4, Landroid/support/v4/app/e;->a:Landroid/support/v4/app/e;
    ...
    iput-object v3, v4, Landroid/support/v4/app/e;->d:Landroid/support/v4/app/Fragment;
    ...
    :cond_6
    iget-object v5, v4, Landroid/support/v4/app/e;->i:Ljava/util/ArrayList;
    ...
    iput-object v5, v4, Landroid/support/v4/app/e;->i:Ljava/util/ArrayList;
    ...
    iget v5, v4, Landroid/support/v4/app/e;->f:I
    ...
    :cond_8
    iget-object v5, p0, Landroid/support/v4/app/d;->a:Landroid/support/v4/app/p;
    ...
    iget v0, v4, Landroid/support/v4/app/e;->e:I
    ...
    iget v1, v4, Landroid/support/v4/app/e;->f:I
